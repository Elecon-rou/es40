...
$ CXX /INCLUDE_DIRECTORY=(PORT_INC,[]) /OPTIMIZE=(LEVEL=4,INLINE=SPEED) NETWORK.CPP
$ CXX /INCLUDE_DIRECTORY=(PORT_INC,[]) /OPTIMIZE=(LEVEL=4,INLINE=SPEED) ES40_DEBUG.CPP
$!
$ CXXLINK ALIM1543C.OBJ,ALPHACPU.OBJ,ALPHASIM.OBJ,DPR.OBJ,FLASH.OBJ,FLOPPYCONTROLLER.OBJ,PORT80.OBJ,SERIAL.OBJ,STDAFX.OBJ,SYSTEMCOMPONENT.OBJ,SYSTEM.OBJ,TRACEENGINE.OBJ,TRANSLATIONBUFFER.OBJ,NETWORK.OBJ,ES40_DEBUG.OBJ /EXECUTABLE=ES40.EXE
$!
$ DEL *.OBJ;*
$!
...
$ CXX /INCLUDE_DIRECTORY=(PORT_INC,[]) /OPTIMIZE=(LEVEL=4,INLINE=SPEED) /DEFINE=IDB NETWORK.CPP
$ CXX /INCLUDE_DIRECTORY=(PORT_INC,[]) /OPTIMIZE=(LEVEL=4,INLINE=SPEED) /DEFINE=IDB ES40_DEBUG.CPP
$!
$ CXXLINK ALIM1543C.OBJ,ALPHACPU.OBJ,ALPHASIM.OBJ,DPR.OBJ,FLASH.OBJ,FLOPPYCONTROLLER.OBJ,PORT80.OBJ,SERIAL.OBJ,STDAFX.OBJ,SYSTEMCOMPONENT.OBJ,SYSTEM.OBJ,TRACEENGINE.OBJ,TRANSLATIONBUFFER.OBJ,NETWORK.OBJ,ES40_DEBUG.OBJ /EXECUTABLE=ES40_IDB.EXE
$!
$ DEL *.OBJ;*
$!
...
$ CXX /INCLUDE_DIRECTORY=(PORT_INC,[]) /OPTIMIZE=(LEVEL=4,INLINE=SPEED) /DEFINE=(IDB,LS_SLAVE) NETWORK.CPP
$ CXX /INCLUDE_DIRECTORY=(PORT_INC,[]) /OPTIMIZE=(LEVEL=4,INLINE=SPEED) /DEFINE=(IDB,LS_SLAVE) ES40_DEBUG.CPP
$!
$ CXXLINK ALIM1543C.OBJ,ALPHACPU.OBJ,ALPHASIM.OBJ,DPR.OBJ,FLASH.OBJ,FLOPPYCONTROLLER.OBJ,PORT80.OBJ,SERIAL.OBJ,STDAFX.OBJ,SYSTEMCOMPONENT.OBJ,SYSTEM.OBJ,TRACEENGINE.OBJ,TRANSLATIONBUFFER.OBJ,LOCKSTEP.OBJ,NETWORK.OBJ,ES40_DEBUG.OBJ /EXECUTABLE=ES40_LSS.EXE
$!
$ DEL *.OBJ;*
$!
...
$ CXX /INCLUDE_DIRECTORY=(PORT_INC,[]) /OPTIMIZE=(LEVEL=4,INLINE=SPEED) /DEFINE=(IDB,LS_MASTER) NETWORK.CPP
$ CXX /INCLUDE_DIRECTORY=(PORT_INC,[]) /OPTIMIZE=(LEVEL=4,INLINE=SPEED) /DEFINE=(IDB,LS_MASTER) ES40_DEBUG.CPP
$!
$ CXXLINK ALIM1543C.OBJ,ALPHACPU.OBJ,ALPHASIM.OBJ,DPR.OBJ,FLASH.OBJ,FLOPPYCONTROLLER.OBJ,PORT80.OBJ,SERIAL.OBJ,STDAFX.OBJ,SYSTEMCOMPONENT.OBJ,SYSTEM.OBJ,TRACEENGINE.OBJ,TRANSLATIONBUFFER.OBJ,LOCKSTEP.OBJ,NETWORK.OBJ,ES40_DEBUG.OBJ /EXECUTABLE=ES40_LSM.EXE
$!
